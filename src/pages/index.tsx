...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert('Pool created successfully, the code has been copied to the clipboard!')
    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      ...
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <strong className="text-gray-100 text-xl flex items-center gap-2">
      ...
      <Image 
        src={appPreviewImg} 
        alt="Two phones showing a preview of the NLW cup mobile application" 
        quality={100}
      />
